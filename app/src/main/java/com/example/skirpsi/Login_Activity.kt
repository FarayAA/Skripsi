...
import com.example.skirpsi.model.ResponseLogin
...
class Login_Activity : AppCompatActivity() {
    ...
    private fun requestLogin() {
        ...
        val call: Call<ResponseLogin> = apiInterface.loginUser(etUsername.text.toString(), etPassword.text.toString())
        call.enqueue(object : Callback<ResponseLogin> {
            ...
            override fun onResponse(call: Call<ResponseLogin>?, response: Response<ResponseLogin>?) {
                ...
                if(response!!.body()!!.status!!){
                    ...
                    sessionManager!!.createSession(response.body()!!.dataLogin!!.idUser!!)
                    sessionManager!!.setNama(
                        response.body()!!.dataLogin!!.idUser!!,
                        response.body()!!.dataLogin!!.namaUser!!,
                        response.body()!!.dataLogin!!.email!!,
                        response.body()!!.dataLogin!!.noHp!!,
                        response.body()!!.dataLogin!!.jenisKelamin!!
                    )
                    sessionManager!!.setId(response.body().dataLogin!!.idUser!!)
